...
<head>
  ...
  <title>@yield('site-title') | Powered By: Riptware.Com</title>
    ...
    <center>
      <a href="" class="brand-link p-1" style=" padding-bottom: 3.5px !important;padding-top: 6px !important;">
        {{-- <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8"> --}}
        <span class="brand-text font-weight-light text-lg text-center"><img src="{{asset('public/admin/dist/img/riptwarev2.png')}}" style="width: 190px;"></span>
      </a>
    </center>
    <!-- Sidebar -->
